...
export function CambiarEstadoModal({ patenteId, estadoActual, onClose, onSaved }: Props) {
  const { user } = useAuth()
  const [estado, setEstado] = useState<EstadoVehiculo>(estadoActual)
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    const { error: insertError } = await supabase.from('estado_vehiculo_historial').insert({
