...
import type { Operador, Patente, Fundo, CategoriaPatente } from '../types'
...
export function useFormData(): FormDataState {
  ...
  return {
    ...
    loading: operadores.loading || patentes.loading || fundos.loading || categoriasVehiculo.loading || tiposPreventiva.loading,
  }
}
